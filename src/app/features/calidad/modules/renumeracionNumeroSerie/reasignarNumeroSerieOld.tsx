...
export const reasignarNumeroSerieOld = () => {
  return (
    <div>reasignarNumeroSerieOld</div>
  )
}
...
// import { InicioHistoryTable } from "app/shared/components/calidad/renumeracionNumeroSerie/InicioHistoryTable";
...
//     try {
//       const newTraza = await dispatch(TrazaManualSliceRequests.PutRequest({ ...trazaManual, trazabilidad: codTrazaD }));
//       const newHistoryTraza = unwrapResult(
//         await dispatch(TrazaManualHistorySliceRequests.PostRequest({ ...trazaManual, id: 0 }))
//       );
//       return newHistoryTraza;
//     } catch (e) {
...
//             inicio: { ...newInicio, codigoTrazabilidad: codigoTrazabilidadDestino },
...
//       const response = await changeTrazaSerieoManual(trazaManual, codigoTrazabilidadDestino);
//     }
//     const save = await saveInicio(objetoInicio);
//     reset();
//   };
