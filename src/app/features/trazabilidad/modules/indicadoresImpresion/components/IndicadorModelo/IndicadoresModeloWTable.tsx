...
import { IndicadoresModeloWForm } from "./IndicadoresModeloWForm";
interface Props {
  tipoModelo: string;
}
export const IndicadoresModeloWTable = ({ tipoModelo }: Props) => {
  ...
  const getAll = async () => {
    try {
      const response = unwrapResult(
        await dispatch(EtiquetasIndicadoresModeloSliceRequests.getAllByTipoM({ tipoM: tipoModelo, tipoU: "W" }))
      );
    ...
    <div className="p-3 mb-3">
      <TableComponent
        columns={[
          ...
          {
            title: "Código modelo ventana",
            field: "codigoModeloVentana"
          },
          {
