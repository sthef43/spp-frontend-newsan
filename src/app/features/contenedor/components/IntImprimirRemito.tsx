...
interface props {
  parentRef?: any;
  fila: IIntRemito | null;
  detalle: IIntDetalle[] | null;
}

export const IntImprimirRemito = ({ parentRef, fila, detalle }: props): JSX.Element => {
  if (!fila) return null;
          ...
          <div className="remito-header">
            ...
            <div className="remito-info">
              ...
              <h2 style={{ marginTop: "5px" }}>
                N° {fila.plantOrigen.organizationCode} {fila.id.toString().padStart(10, "0")}
              </h2>
            </div>
          </div>
