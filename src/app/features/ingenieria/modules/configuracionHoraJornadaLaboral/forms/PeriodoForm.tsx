...
interface props {
  setOpenPopup: any;
  editState?: IPeriodo | null;
  refresh?: any;
  estaEditando: any;
}
export const PeriodoForm = ({ setOpenPopup, editState, refresh, estaEditando }: props) => {
  ...
  const loginSubmit = async (e) => {
    ...
    try {
      if (editState) {
        result = await dispatch(PeriodoSliceRequests.putRequest(JSON.parse(JSON.stringify(e))));
      } else {
        result = await dispatch(PeriodoSliceRequests.postRequest(JSON.parse(JSON.stringify(e))));
      }
    } catch (x) {
      result = null;
    }
