        ...
        <div className="p-4 m-2 rounded-lg shadow-elevation-2 bg-secondaryNew">
          <Grow in={showModal} timeout={500}>
            <main className="w-full border border-gray-300 rounded-md shadow-lg">
              ...
              <form onSubmit={handleSubmit(addModelo)} className="flex flex-col justify-center gap-5 p-4">
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex flex-col items-start w-full">
                    ...
                    {errors.nombre && (
                      <FormHelperText className="text-red-500">{errors.EANCODE.message}</FormHelperText>
                    )}
                  </div>
                </div>
